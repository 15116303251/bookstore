	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			<div class="layui-main">
				<a href="${ctx}/index.shtml" class="logo">BK-MANAGER管理平台</a>
				<!-- 顶部右侧菜单 -->
				<ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" pc><a href="javascript:;"> <img
							src="assets/LayuiImages/userface4.jpg" class="layui-circle" width="35"
							height="35">
						<cite>
							${backName}
					    </cite>
...
<%-- 							<dd>
							...
							<%--</dd>--%>
							<dd>
								<a href="/backLogin" class="noAddTab"><i
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<c:forEach var="menu" items="${menus}">
						...
						<c:forEach var="childMenus" items="${menu.children}">
							<dd>
								<a class="meun_a" href="javascript:;" data-url="${childMenus.dataUrl}" title="${childMenus.name}">&nbsp;&nbsp;<i
		...
		<div class="layui-body">
			...
			<div id="mds_manager_body">
				<div class="dx-welcome" style="	background-image: url(assets/LayuiImages/welcome.png);"></div>
				<h5 class="dx-welcome-title">欢迎进入BK-MANAGER管理平台，请点击左侧菜单开始操作吧！</h5>
			</div>
		</div>
		<div class="layui-footer footer">
			<div class="layui_main">
				<p>@2018 BK-MANAGER管理平台</p>
			</div>
		</div>
	</div>
