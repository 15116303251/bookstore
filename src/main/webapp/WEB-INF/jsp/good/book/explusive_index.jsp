...
<script src="assets/js/good/book/explusive_index.js"></script>
...
<div class="body_center" style="overflow: auto">
	...
	<div class="div_centent_right">
		<div class="layui-btn-group">
			<button class="layui-btn layui-btn-primary" id="ExplusiveAdd">
				<i class="iconfont">&#xe6e2;</i> 添加
			</button>
			<button class="layui-btn layui-btn-primary" id="ExplusiveDel">
