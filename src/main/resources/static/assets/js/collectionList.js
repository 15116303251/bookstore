            ...
            success : function(data) {
                for(var k=0;k<data.list.length;k=k+1){
                    totalItem=totalItem+"<li class=\"line1\" >\n" +
                        "    <a  class=\"pic\" href=\"goodToDetail?bDBid="+data.list[k].bDBid+"&bookId="+data.list[k].id+"\" target=\"_blank\">\n" +
                        "        <img src=\"assets/images/"+data.list[k].image+"\">\n" +
                        "    </a>\n" +
                        "    <p class=\"name\">\n" +
                        "        <a href=\"goodToDetail?bDBid="+data.list[k].bDBid+"&bookId="+data.list[k].id+"\" target=\"_blank\"> \n" +
                        ...
                        "        <p class=\"bottom_p\">\n" +
                        "            <a class=\"search_btn_cart\" name=\"area_buy\" href=\"goodToDetail?bDBid="+data.list[k].bDBid+"&bookId="+data.list[k].id+"\">详细信息</a>\n" +
                        "            <a class=\"search_btn_cart\" name=\"area_buy\" href=\"collectionDelete?bDBid="+data.list[k].bDBid+"&bookId="+data.list[k].id+"\">取消收藏</a>\n" +
                        "            </p>\n" +
                        "    </div>\n" +
                        "</li>";
                }
