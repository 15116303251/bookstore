...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="toPayPage" method=post
			  target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value=${orderVo.orderId}/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
					...
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${orderVo.payment}"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
