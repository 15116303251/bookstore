...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="bookUpdate">
                <div class="form-group">
                    <label class="col-sm-4 control-label"></label>
                    <div class="col-sm-4">
                        <input type="hidden" class="form-control" name="flag" value="${bt.bDBid}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label"></label>
                    <div class="col-sm-4">
                        <input type="hidden" class="form-control" name="Id" value="${bt.id}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">书名</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="bookName" value="${bt.bookName}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label" >作者</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="author" value="${bt.author}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">出版社</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="publish" value="${bt.publish}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">出版日期</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="publishDate" value="${bt.publishDate}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">原价</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="originalPrice" value="${bt.originalPrice}"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-4 control-label">折扣</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="discountedPrice" value="${bt.discountedPrice}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="Amount" value="${bt.stock}"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" name="description" cols="20" rows="5" name="description" value="${bt.description}"></textarea>
                    </div>
                </div>
                <div class="form-group">
